...
public class KafkaTopology {
    ...
    public static void main(String[] args) {
        try {
            ...
            builder.setBolt("DecodeBolt", new DecodeBolt(), 1).globalGrouping("KafkaSpout");
            builder.setBolt("AverageBolt", new AverageSpeedBolt(), 1).fieldsGrouping("DecodeBolt", new Fields("mmsi"));
            builder.setBolt("FilterBolt", new SpeedFilterBolt(), 1).allGrouping("DecodeBolt");
            builder.setBolt("CountPort", new CountShipsBolt(), 1).shuffleGrouping("FilterBolt");
